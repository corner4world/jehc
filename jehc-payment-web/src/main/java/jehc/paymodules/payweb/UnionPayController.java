...
import static jehc.paymodules.union.model.UnionTransactionType.WEB;
...
public class UnionPayController {
    ...
    @PostConstruct
    public void init() {
        UnionPayConfigDaoImpl unionPayConfigStorage = new UnionPayConfigDaoImpl();
        ...
        service = new UnionPayServiceImpl(unionPayConfigStorage);
        //请求连接池配置
