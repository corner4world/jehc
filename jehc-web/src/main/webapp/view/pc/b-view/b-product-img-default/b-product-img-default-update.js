...
function updateBProductImgDefault(){
	submitBForm('defaultForm','../bProductImgDefaultController/updateBProductImgDefault',"../bProductImgDefaultController/loadBProductImgDefault?b_product_id="+$('#b_product_id').val());
}
//初始化日期选择器
