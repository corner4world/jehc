...
function updateBProductColorDefault(){
	submitBForm('defaultForm','../bProductColorDefaultController/updateBProductColorDefault',"../bProductColorDefaultController/loadBProductColorDefault?b_product_id="+$('#b_product_id').val());
}
//初始化日期选择器
