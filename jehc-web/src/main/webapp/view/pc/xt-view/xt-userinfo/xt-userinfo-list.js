		...
		colums:[
			...
			},
			{
				...
				render:function(data, type, row, meta) {
					...
					var btn = '<button class="btn btn-sm green btn-outline filter-submit margin-bottom" onclick=toXtUserinfoDetail("'+data+'")><i class="glyphicon glyphicon-eye-open"></i>详情</button>';
						btn = btn +'<button class="btn btn-sm green btn-outline filter-submit margin-bottom" onclick=initRoleinfo("'+data+'")><i class="glyphicon glyphicon-check"></i>角色权限</button>';
						btn = btn +'<button class="btn btn-sm green btn-outline filter-submit margin-bottom" onclick=resetXtUserinfoPwd("'+data+'","'+xt_userinfo_realName+'","'+xt_userinfo_name+'")><i class="glyphicon glyphicon-edit"></i>重置密码</button>';
					return btn;
				}
			}
		]
