$(function () {
    ...
    function c() {
        ...
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" indexId="'+m+'" idBu ="'+idBu+'" rootId="'+rootId+'" data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
            $(".J_menuTab").removeClass("active");
            var n = '<iframe class="J_iframe" id="iframe' + m + '" indexId="'+m+'" idBu ="'+idBu+'" rootId="'+rootId+'" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
