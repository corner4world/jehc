	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateOaSuggestionbox()">保存</button>
...
<script type="text/javascript" src="../view/pc/oa-view/oa-suggestionbox/oa-suggestionbox-update.js"></script> 
</html>
