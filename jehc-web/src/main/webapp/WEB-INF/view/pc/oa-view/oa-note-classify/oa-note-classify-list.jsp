...
<body>
		...
		<div class="portlet-body form">
			<form method="POST" id="searchForm" class="form-inline" style="padding: 5px 0px 5px 0px;">
				<div class="form-group">
					<label>分类名称</label>
					<input type="text" class="form-control" name="oa_note_classify_name" placeholder="请输入分类名称">
				</div>
				&nbsp;
	...
	<div class="pull-left form-actions" style="margin-right:0px;margin-bottom: 5px">
		<button class="btn btn-outline-success waves-light waves-effect" onclick="toOaNoteClassifyAdd()">
			<i class="fa fa-plus-circle"></i>新增
		</button>
		<button class="btn btn-outline-info waves-light waves-effect" onclick="toOaNoteClassifyUpdate()">
			<i class="fa fa-pencil"></i>修改
		</button>
		<button class="btn btn-outline-danger waves-light waves-effect" onclick="delOaNoteClassify()">
...
<script type="text/javascript" src="../view/pc/oa-view/oa-note-classify/oa-note-classify-list.js"></script> 
</html>
