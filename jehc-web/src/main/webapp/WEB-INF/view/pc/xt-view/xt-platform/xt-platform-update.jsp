			...
			<div class="form-group"><div class="col-lg-3"><a class="btn btn-danger" href="javascript:delXtPlatformFeedbackItems(this,${xtPlatformFeedbackStatus.index})" >删除该条信息</a></div></div>
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<img src = "../deng/images/default/add_d.png" class="img" id="xtPlatformFeedback_${xtPlatformFeedbackStatus.index}_xt_userinfo_id_pic">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<img src = "../deng/images/default/add_d.png" class="img" id="xtPlatformFeedback_${xtPlatformFeedbackStatus.index}_xt_platform_feedback_remark_pic">
						</div>
					</div>
					<div class="form-group">
