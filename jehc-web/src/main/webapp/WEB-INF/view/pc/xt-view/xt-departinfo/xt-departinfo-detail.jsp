	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="20"  readonly="readonly" style="width: 150px;" name="xt_departinfo_time" placeholder="请输入立成时间" value="${xtDepartinfo.xt_departinfo_time }">
				</div>
			</div>
			<div class="form-group">
