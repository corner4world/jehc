						...
						<div class="row">
							<div class="col m--align-left">
								<jEhcPermissionTag:jehcBtnTag modules="addXtNotice">
									<a class="btn btn-default" onclick="toXtNoticeAdd()">
