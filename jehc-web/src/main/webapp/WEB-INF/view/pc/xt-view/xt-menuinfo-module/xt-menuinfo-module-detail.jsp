	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form_datetime form-control" name="ctime"  placeholder="请选择时间" value="${xtMenuinfoModule.ctime }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">最后修改时间</label>
				<div class="col-lg-6">
					<input class="form_datetime form-control" name="mtime"  placeholder="请选择时间" value="${xtMenuinfoModule.mtime }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">创建人</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="xt_userinfo_id" placeholder="请输入创建人" value="${xtMenuinfoModule.xt_userinfo_realName }">
				</div>
			</div>
			<div class="form-group">
...
<script type="text/javascript" src="../view/pc/xt-view/xt-menuinfo-module/xt-menuinfo-module-detail.js"></script> 
</html>
