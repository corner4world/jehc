			...
			<form class="m-form m-form--fit m-form--label-align-left m-form--group-seperator-dashed " method="POST" id="searchForm">
				<div class="m-portlet__body">	
					<div class="form-group m-form__group row">
						<label class="col-form-label">停止时间:</label>
						<div class="col-lg-2">
						...
						<label class="col-form-label">启动时间:</label>
						<div class="col-lg-2">
							<div class="input-group">
					...
					<div class="m-form__actions m-form__actions--solid">
						<div class="row">
							<div class="col m--align-left">
								<a class="btn btn-secondary m-btn m-btn--custom m-btn--icon" href="javascript:delXtStartStopLog()">
