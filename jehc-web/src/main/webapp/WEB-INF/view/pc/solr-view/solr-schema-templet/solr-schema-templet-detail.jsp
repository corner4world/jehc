...
<head>
<meta charset="UTF-8">
<title>solr schema 模板详情页面</title>
</head>
<body>
	<div class="panel-body">
		<div class="page-header">
			<h4>solr schema 模板详情</h4>
		</div>
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="xt_userinfo_id" placeholder="请输入操作人" value="${solrSchemaTemplet.xt_userinfo_realName }">
				</div>
			</div>
			<div class="form-group">
