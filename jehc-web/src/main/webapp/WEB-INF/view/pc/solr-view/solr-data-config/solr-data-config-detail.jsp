...
<head>
<meta charset="UTF-8">
<title>solr_data_config模板配置详情页面</title>
</head>
<body>
	<div class="panel-body">
		<div class="page-header">
			<h4>solr_data_config模板配置详情</h4>
		</div>
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32"  name="xt_userinfo_realName" placeholder="请输入操作人" value="${solrDataConfig.xt_userinfo_realName }">
				</div>
			</div>
			<div class="form-group">
