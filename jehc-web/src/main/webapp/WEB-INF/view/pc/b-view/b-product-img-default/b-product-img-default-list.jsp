...
<body>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			...
			<button class="btn btn-default" onclick="toBProductImgDefaultAdd()">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
			</button>
			<button class="btn btn-default" onclick="toBProductImgDefaultUpdate()">
				<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
			</button>
			<button class="btn btn-default" onclick="delBProductImgDefault()">
