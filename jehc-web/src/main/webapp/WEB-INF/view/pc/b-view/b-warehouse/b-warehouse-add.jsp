	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="100"  name="b_warehouse_name" placeholder="请输入仓库名称">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="200"  name="b_warehouse_address" placeholder="请输入详细地址">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">仓库类型</label>
				<div class="col-lg-6">
					<select class="form-control" name="b_warehouse_type" style="width:150px;">
						<option>请选择</option>
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="addBWarehouse()">保存</button>
