...
<body>
		...
		<fieldset>
			...
			<form method="POST" id="searchForm" class="form-inline">
				...
				<div class="form-group">
					<label>名称</label>
					<input type="text" class="form-control" name="b_product_color_name" placeholder="请输入名称">
				</div>
			</form>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			...
			<button class="btn btn-default" onclick="toBProductColorAdd()">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
			</button>
			<button class="btn btn-default" onclick="toBProductColorUpdate()">
				<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
			</button>
			<button class="btn btn-default" onclick="delBProductColor()">
