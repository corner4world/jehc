	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" maxlength="10" value="0"  data-bv-numeric data-bv-numeric-message="宽&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;度为数字类型"  name="b_product_color_default_width" placeholder="请输入宽&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;度" value="${bProductColorDefault.b_product_color_default_width }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">高&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;度</label>
				<div class="col-lg-6">
					<input class="form-control" maxlength="10" value="0"  data-bv-numeric data-bv-numeric-message="高&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;度为数字类型"  name="b_product_color_default_height" placeholder="请输入高&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;度" value="${bProductColorDefault.b_product_color_default_height }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">排&nbsp;&nbsp;序&nbsp;&nbsp;号</label>
				<div class="col-lg-6">
					<input class="form-control" maxlength="10"  data-bv-numeric data-bv-numeric-message="排&nbsp;&nbsp;序&nbsp;&nbsp;号为数字类型"  name="b_product_color_default_sort" placeholder="请输入排&nbsp;&nbsp;序&nbsp;&nbsp;号" value="${bProductColorDefault.b_product_color_default_sort }">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group" style="display: none;">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32" id="b_product_id" name="b_product_id" placeholder="请输入商品编号" value="${bProductColorDefault.b_product_id }">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateBProductColorDefault()">保存</button>
