	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" maxlength="10" style="width:120px"  data-bv-numeric data-bv-numeric-message="图片宽度为数字类型"  name="b_product_img_width" placeholder="请输入图片宽度" value="${bProductImgDefault.b_product_img_width }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">图片高度</label>
				<div class="col-lg-6">
					<input class="form-control" maxlength="10"  style="width:120px" data-bv-numeric data-bv-numeric-message="图片高度为数字类型"  name="b_product_img_height" placeholder="请输入图片高度" value="${bProductImgDefault.b_product_img_height }">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateBProductImgDefault()">保存</button>
