		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					...
					<fmt:formatDate value="${bRecommend.b_recommend_ctime }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-6">
					<label class="control-label">
					<fmt:formatDate value="${bRecommend.b_recommend_mtime }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-6">
					<label class="control-label">
					${bRecommend.xt_userinfo_realName }
					</label>
				</div>
			</div>
			<div class="form-group">
