...
<body>
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<input class="form-control" type="hidden" value="${fn:length(crmCustomer.crmCustomerAttach) }" name="crmCustomerAttachFormNumber" id="crmCustomerAttachFormNumber" >
			...
			<div class="row">
				...
				<div class="col-lg-2">
					<input class="form-control" type="text" maxlength="255"  name="name" placeholder="请输入客户名称" value="${crmCustomer.name }">
				</div>
				<div class="col-md-1">
					<label class="control-label">客户简称</label>
				</div>
				<div class="col-lg-2">
					<input class="form-control" type="text" maxlength="64"  name="shortName" placeholder="请输入客户简称" value="${crmCustomer.shortName }">
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-2">
	        		...
	        		<select class="form-control" id="scaleId"  name="scaleId" placeholder="请输入公司规模，注：数据字典读取"></select>
				</div>
				<div class="col-md-1">
				...
				<div class="col-lg-2">
	        		...
	        		<select class="form-control" id="ageScope"  name="ageScope" placeholder="请输入年龄结构，注：数据字典读取"></select>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-lg-2">
					<input class="form-control" type="text" maxlength="32"  name="corporation" placeholder="请输入公司法人" value="${crmCustomer.corporation }">
				</div>
				<div class="col-md-1">
					<label class="control-label">公司电话</label>
				</div>
				<div class="col-lg-2">
					<input class="form-control" type="text" maxlength="255"  name="tel" placeholder="请输入公司电话" value="${crmCustomer.tel }">
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-lg-2">
					<input class="form_datetime form-control" readonly="readonly" type="text" name="endTime" value="<fmt:formatDate value='${crmCustomer.endTime}' pattern="yyyy-MM-dd"/>">
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-md-2">
					<input class="form-control" type="text" maxlength="255"  value="${crmCustomer.address }" name="address" placeholder="请输入详细地址">
				</div>
			</div>
			<div class="page-header">
				<h4>附件资料</h4>
			...
			<div class="form_crmCustomerAttach form-inline">
				...
				<fieldset>
					...
					<div class="form-group"><div class="col-lg-3"><a class="btn btn-danger" href="javascript:delCrmCustomerAttachItems(this,${crmCustomerAttachStatus.index})" >删除该条信息</a></div></div>
				</fieldset>
				</div>
				</c:forEach>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-2">
					<input type="hidden" name="invoiceId" value="${crmInvoice.invoiceId }">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<input class="form-control" type="text" maxlength="32"  name="invoiceName" placeholder="请输入发票名称" value="${crmInvoice.invoiceName }">
				</div>
				<div class="col-md-1">
					<label class="control-label">发票税号</label>
				</div>
				<div class="col-md-2">
					<input class="form-control" type="text" maxlength="32"  name="invoiceTaxNumber" placeholder="请输入发票税号" value="${crmInvoice.invoiceTaxNumber }">
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-md-2">
					<input class="form-control" type="hidden" maxlength="32"  id="createUser" value="${crmCustomer.createUser }">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<jEhcPermissionTag:jehcBtnTag modules="crmCustomerController/updateCrmCustomer" systemUID="${crmCustomer.createUser }">
						<button type="button" class="btn green" onclick="updateCrmCustomer()">保存</button>
...
<script type="text/javascript" src="../view/pc/crm-view/crm-customer/crm-customer-update.js"></script> 
</html>
