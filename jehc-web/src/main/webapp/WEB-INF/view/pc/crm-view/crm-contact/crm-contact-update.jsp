	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="64" style="width: 220px;"  name="contactName" data-bv-notempty data-bv-notempty-message="请输入姓名"  placeholder="请输入姓名" value="${crmContact.contactName }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">联系电话</label>
				<div class="col-lg-6">
					<input class="form-control" type="text"style="width: 220px;" maxlength="255"  name="contactTel" placeholder="请输入联系人电话" value="${crmContact.contactTel }">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-2">
	        		...
	        		<select class="form-control" id="postId" style="width: 220px;" name="postId" placeholder="请输入岗位"></select>
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">在职状态</label>
				<div class="col-lg-6">
					<select name="incumbency" style="width: 220px;" class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateCrmContact()">保存</button>
...
<script type="text/javascript" src="../view/pc/crm-view/crm-contact/crm-contact-update.js"></script> 
</html>
