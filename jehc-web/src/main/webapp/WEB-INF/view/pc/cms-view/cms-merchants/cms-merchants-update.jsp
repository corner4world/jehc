	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="hidden" name="imgpath" id="imgpath" value="${cmsMerchants.imgpath }">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="updateCmsMerchants()">保存</button>
...
<script type="text/javascript" src="../view/pc/cms-view/cms-merchants/cms-merchants-update.js"></script>
<script>
