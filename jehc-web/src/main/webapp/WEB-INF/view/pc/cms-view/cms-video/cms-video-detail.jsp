	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<select class="form-control select_boot" name="status" >
						<option value="0" <c:if test="${cmsVideo.status eq 0 }">selected</c:if> >正常</option>
						<option value="1" <c:if test="${cmsVideo.status eq 1 }">selected</c:if> >关闭</option>
					</select>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<fmt:formatDate value="${cmsVideo.ctime }" pattern="yyyy-MM-dd HH:mm:ss"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">修改时间</label>
				<div class="col-lg-6">
					<fmt:formatDate value="${cmsVideo.mtime }" pattern="yyyy-MM-dd HH:mm:ss"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">创建人</label>
				<div class="col-lg-6">
					${cmsVideo.xt_userinfo_realName }
				</div>
			</div>
			<div class="form-group">
...
<script type="text/javascript" src="../view/pc/cms-view/cms-video/cms-video-detail.js"></script> 
</html>
