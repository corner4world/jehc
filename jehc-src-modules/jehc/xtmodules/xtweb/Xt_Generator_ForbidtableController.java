...
public class Xt_Generator_ForbidtableController extends BaseAction{
	@Autowired
	...
	*/
	...
	public ModelAndView loadXtGeneratorForbidtable(Xt_Generator_Forbidtable xt_Generator_Forbidtable,HttpServletRequest request){
	...
	*/
	...
	public String getXtGeneratorForbidtableListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		List<Xt_Generator_Forbidtable> xt_Generator_ForbidtableList = xt_Generator_ForbidtableService.getXtGeneratorForbidtableListByCondition(condition);
		PageInfo<Xt_Generator_Forbidtable> page = new PageInfo<Xt_Generator_Forbidtable>(xt_Generator_ForbidtableList);
	...
	*/
	...
	public String getXtGeneratorForbidtableById(String xt_generator_forbidtable_id,HttpServletRequest request){
		Xt_Generator_Forbidtable xt_Generator_Forbidtable = xt_Generator_ForbidtableService.getXtGeneratorForbidtableById(xt_generator_forbidtable_id);
	...
	*/
	...
	public String addXtGeneratorForbidtable(Xt_Generator_Forbidtable xt_Generator_Forbidtable,HttpServletRequest request){
		int i = 0;
		if(null != xt_Generator_Forbidtable && !"".equals(xt_Generator_Forbidtable)){
			...
			i=xt_Generator_ForbidtableService.addXtGeneratorForbidtable(xt_Generator_Forbidtable);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtGeneratorForbidtable(Xt_Generator_Forbidtable xt_Generator_Forbidtable,HttpServletRequest request){
		int i = 0;
		if(null != xt_Generator_Forbidtable && !"".equals(xt_Generator_Forbidtable)){
			xt_Generator_Forbidtable.setXt_generator_forbidtable_mtime(getSimpleDateFormat());
			xt_Generator_Forbidtable.setXt_userinfo_id(getXtUid());
			i=xt_Generator_ForbidtableService.updateXtGeneratorForbidtable(xt_Generator_Forbidtable);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtGeneratorForbidtable(String xt_generator_forbidtable_id,HttpServletRequest request){
		...
		if(null != xt_generator_forbidtable_id && !"".equals(xt_generator_forbidtable_id)){
			...
			i=xt_Generator_ForbidtableService.delXtGeneratorForbidtable(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
