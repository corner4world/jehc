...
public class Xt_Change_PwdController extends BaseAction{
	@Autowired
	private Xt_Change_PwdService xt_Change_PwdService;
	/**
	* 载入初始化页面
	* @param xt_change_pwd 
	* @param request 
	...
	*/
	...
	public ModelAndView loadXtChangePwd(Xt_Change_Pwd xt_Change_Pwd,HttpServletRequest request){
	...
	*/
	...
	public String getXtChangePwdListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		List<Xt_Change_Pwd> xt_Change_PwdList = xt_Change_PwdService.getXtChangePwdListByCondition(condition);
		PageInfo<Xt_Change_Pwd> page = new PageInfo<Xt_Change_Pwd>(xt_Change_PwdList);
	...
	*/
	...
	public String getXtChangePwdById(String xt_change_pwd_id,HttpServletRequest request){
		Xt_Change_Pwd xt_Change_Pwd = xt_Change_PwdService.getXtChangePwdById(xt_change_pwd_id);
	...
	*/
	...
	public String addXtChangePwd(Xt_Change_Pwd xt_Change_Pwd,HttpServletRequest request){
		int i = 0;
		if(null != xt_Change_Pwd && !"".equals(xt_Change_Pwd)){
			xt_Change_Pwd.setXt_change_pwd_id(UUID.toUUID());
			i=xt_Change_PwdService.addXtChangePwd(xt_Change_Pwd);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtChangePwd(Xt_Change_Pwd xt_Change_Pwd,HttpServletRequest request){
		int i = 0;
		if(null != xt_Change_Pwd && !"".equals(xt_Change_Pwd)){
			i=xt_Change_PwdService.updateXtChangePwd(xt_Change_Pwd);
		}
		if(i>0){
	...
	*/
	...
	public String delXtChangePwd(String xt_change_pwd_id,HttpServletRequest request){
		...
		if(null != xt_change_pwd_id && !"".equals(xt_change_pwd_id)){
			...
			i=xt_Change_PwdService.delXtChangePwd(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
