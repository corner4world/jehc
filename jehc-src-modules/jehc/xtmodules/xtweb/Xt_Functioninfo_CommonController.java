...
public class Xt_Functioninfo_CommonController extends BaseAction{
	@Autowired
	private Xt_Functioninfo_CommonService xt_Functioninfo_CommonService;
	/**
	* 载入初始化页面
	...
	*/
	...
	public ModelAndView loadXtFunctioninfoCommon(Xt_Functioninfo_Common xt_Functioninfo_Common,HttpServletRequest request){
	...
	*/
	...
	public String getXtFunctioninfoCommonListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		PageInfo<Xt_Functioninfo_Common> page = new PageInfo<Xt_Functioninfo_Common>(xt_Functioninfo_CommonList);
	...
	*/
	...
	public String getXtFunctioninfoCommonById(String xt_functioninfo_common_id,HttpServletRequest request){
		Xt_Functioninfo_Common xt_Functioninfo_Common = xt_Functioninfo_CommonService.getXtFunctioninfoCommonById(xt_functioninfo_common_id);
	...
	*/
	...
	public String addXtFunctioninfoCommon(Xt_Functioninfo_Common xt_Functioninfo_Common,HttpServletRequest request){
		int i = 0;
		if(null != xt_Functioninfo_Common && !"".equals(xt_Functioninfo_Common)){
			...
			i=xt_Functioninfo_CommonService.addXtFunctioninfoCommon(xt_Functioninfo_Common);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtFunctioninfoCommon(Xt_Functioninfo_Common xt_Functioninfo_Common,HttpServletRequest request){
		int i = 0;
		if(null != xt_Functioninfo_Common && !"".equals(xt_Functioninfo_Common)){
			xt_Functioninfo_Common.setXt_functioninfo_common_mtime(getSimpleDateFormat());
			xt_Functioninfo_Common.setXt_userinfo_id(getXtUid());
			i=xt_Functioninfo_CommonService.updateXtFunctioninfoCommon(xt_Functioninfo_Common);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtFunctioninfoCommon(String xt_functioninfo_common_id,HttpServletRequest request){
		...
		if(null != xt_functioninfo_common_id && !"".equals(xt_functioninfo_common_id)){
			...
			i=xt_Functioninfo_CommonService.delXtFunctioninfoCommon(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
