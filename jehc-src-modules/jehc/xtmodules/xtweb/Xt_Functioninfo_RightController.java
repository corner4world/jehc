...
public class Xt_Functioninfo_RightController extends BaseAction{
	@Autowired
	...
	*/
	...
	public ModelAndView loadXtFunctioninfoRight(Xt_Functioninfo_Right xt_Functioninfo_Right,HttpServletRequest request){
	...
	*/
	...
	public String getXtFunctioninfoRightListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		PageInfo<Xt_Functioninfo_Right> page = new PageInfo<Xt_Functioninfo_Right>(xt_Functioninfo_RightList);
	...
	*/
	...
	public String getXtFunctioninfoRightById(String xt_functioninfo_right_id,HttpServletRequest request){
		Xt_Functioninfo_Right xt_Functioninfo_Right = xt_Functioninfo_RightService.getXtFunctioninfoRightById(xt_functioninfo_right_id);
	...
	*/
	...
	public String addXtFunctioninfoRight(Xt_Functioninfo_Right xt_Functioninfo_Right,HttpServletRequest request){
		int i = 0;
		if(null != xt_Functioninfo_Right && !"".equals(xt_Functioninfo_Right)){
			xt_Functioninfo_Right.setXt_functioninfo_right_id(UUID.toUUID());
			i=xt_Functioninfo_RightService.addXtFunctioninfoRight(xt_Functioninfo_Right);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtFunctioninfoRight(Xt_Functioninfo_Right xt_Functioninfo_Right,HttpServletRequest request){
		int i = 0;
		if(null != xt_Functioninfo_Right && !"".equals(xt_Functioninfo_Right)){
			i=xt_Functioninfo_RightService.updateXtFunctioninfoRight(xt_Functioninfo_Right);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtFunctioninfoRight(String xt_functioninfo_right_id,HttpServletRequest request){
		...
		if(null != xt_functioninfo_right_id && !"".equals(xt_functioninfo_right_id)){
			...
			i=xt_Functioninfo_RightService.delXtFunctioninfoRight(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
