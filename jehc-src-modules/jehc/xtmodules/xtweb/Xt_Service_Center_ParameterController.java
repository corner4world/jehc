...
public class Xt_Service_Center_ParameterController extends BaseAction{
	@Autowired
	...
	*/
	...
	public ModelAndView loadXtServiceCenterParameter(Xt_Service_Center_Parameter xt_Service_Center_Parameter,HttpServletRequest request){
	...
	*/
	...
	public String getXtServiceCenterParameterListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		PageInfo<Xt_Service_Center_Parameter> page = new PageInfo<Xt_Service_Center_Parameter>(xt_Service_Center_ParameterList);
	...
	*/
	...
	public String getXtServiceCenterParameterById(String xt_service_center_parameter_id,HttpServletRequest request){
		Xt_Service_Center_Parameter xt_Service_Center_Parameter = xt_Service_Center_ParameterService.getXtServiceCenterParameterById(xt_service_center_parameter_id);
	...
	*/
	...
	public String addXtServiceCenterParameter(Xt_Service_Center_Parameter xt_Service_Center_Parameter,HttpServletRequest request){
		int i = 0;
		if(null != xt_Service_Center_Parameter && !"".equals(xt_Service_Center_Parameter)){
			...
			i=xt_Service_Center_ParameterService.addXtServiceCenterParameter(xt_Service_Center_Parameter);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtServiceCenterParameter(Xt_Service_Center_Parameter xt_Service_Center_Parameter,HttpServletRequest request){
		int i = 0;
		if(null != xt_Service_Center_Parameter && !"".equals(xt_Service_Center_Parameter)){
			i=xt_Service_Center_ParameterService.updateXtServiceCenterParameter(xt_Service_Center_Parameter);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtServiceCenterParameter(String xt_service_center_parameter_id,HttpServletRequest request){
		...
		if(null != xt_service_center_parameter_id && !"".equals(xt_service_center_parameter_id)){
			...
			i=xt_Service_Center_ParameterService.delXtServiceCenterParameter(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
