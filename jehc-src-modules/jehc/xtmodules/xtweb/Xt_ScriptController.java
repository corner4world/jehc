...
public class Xt_ScriptController extends BaseAction{
	@Autowired
	private Xt_ScriptService xt_ScriptService;
	/**
	* 载入初始化页面
	* @param xt_script 
	* @param request 
	...
	*/
	...
	public ModelAndView loadXtScript(Xt_Script xt_Script,HttpServletRequest request){
	...
	*/
	...
	public String getXtScriptListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		List<Xt_Script> xt_ScriptList = xt_ScriptService.getXtScriptListByCondition(condition);
		PageInfo<Xt_Script> page = new PageInfo<Xt_Script>(xt_ScriptList);
	...
	*/
	...
	public String getXtScriptById(String xt_script_id,HttpServletRequest request){
		Xt_Script xt_Script = xt_ScriptService.getXtScriptById(xt_script_id);
	...
	*/
	...
	public String addXtScript(Xt_Script xt_Script,HttpServletRequest request){
		int i = 0;
		if(null != xt_Script && !"".equals(xt_Script)){
			...
			i=xt_ScriptService.addXtScript(xt_Script);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtScript(Xt_Script xt_Script,HttpServletRequest request){
		int i = 0;
		if(null != xt_Script && !"".equals(xt_Script)){
			...
			xt_Script.setXt_script_content(request.getParameter("xt_script_content"));
			xt_Script.setXt_script_text(request.getParameter("xt_script_text"));
			i=xt_ScriptService.updateXtScript(xt_Script);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtScript(String xt_script_id,HttpServletRequest request){
		...
		if(null != xt_script_id && !"".equals(xt_script_id)){
			...
			i=xt_ScriptService.delXtScript(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String getXtScriptList(Xt_Script xt_Script,HttpServletRequest request){
		Map<String, Object> condition = new HashMap<String, Object>();
