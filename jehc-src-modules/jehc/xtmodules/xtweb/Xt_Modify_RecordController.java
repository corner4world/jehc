...
public class Xt_Modify_RecordController extends BaseAction{
	@Autowired
	private Xt_Modify_RecordService xt_Modify_RecordService;
	/**
	* 载入初始化页面
	...
	*/
	...
	public ModelAndView loadXtModifyRecord(Xt_Modify_Record xt_Modify_Record,HttpServletRequest request){
	...
	*/
	...
	public String getXtModifyRecordListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		List<Xt_Modify_Record> xt_Modify_RecordList = xt_Modify_RecordService.getXtModifyRecordListByCondition(condition);
		PageInfo<Xt_Modify_Record> page = new PageInfo<Xt_Modify_Record>(xt_Modify_RecordList);
	...
	*/
	...
	public String getXtModifyRecordById(String xt_modify_record_id,HttpServletRequest request){
		Xt_Modify_Record xt_Modify_Record = xt_Modify_RecordService.getXtModifyRecordById(xt_modify_record_id);
	...
	*/
	...
	public String addXtModifyRecord(Xt_Modify_Record xt_Modify_Record,HttpServletRequest request){
		int i = 0;
		if(null != xt_Modify_Record && !"".equals(xt_Modify_Record)){
			xt_Modify_Record.setXt_modify_record_id(UUID.toUUID());
			i=xt_Modify_RecordService.addXtModifyRecord(xt_Modify_Record);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtModifyRecord(Xt_Modify_Record xt_Modify_Record,HttpServletRequest request){
		int i = 0;
		if(null != xt_Modify_Record && !"".equals(xt_Modify_Record)){
			i=xt_Modify_RecordService.updateXtModifyRecord(xt_Modify_Record);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delXtModifyRecord(String xt_modify_record_id,HttpServletRequest request){
		...
		if(null != xt_modify_record_id && !"".equals(xt_modify_record_id)){
			...
			i=xt_Modify_RecordService.delXtModifyRecord(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
