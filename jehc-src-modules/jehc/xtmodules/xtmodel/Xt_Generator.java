 ...
 *
 */
public class Xt_Generator implements Serializable{
	...
	private List<Xt_Generator_Search_Filed> xt_generator_search_filedList;/**查询字段封装**/
	private List<Xt_Generator_Grid_Column> xt_Generator_Grid_ColumnList;/**GridList列表字段封装**/
	private List<Xt_Generator_Table_Column_Form> xt_Generator_Table_Column_FormList;/**新增 编辑 明细表单等字段封装**/
	...
	private List<Xt_Generator_TableMany_To_One> xt_Generator_TableMany_To_OneList;/**子表集合**/
	public List<Xt_Generator_Search_Filed> getXt_generator_search_filedList() {
		return xt_generator_search_filedList;
	}
	public void setXt_generator_search_filedList(
			List<Xt_Generator_Search_Filed> xt_generator_search_filedList) {
	...
	public List<Xt_Generator_Grid_Column> getXt_Generator_Grid_ColumnList() {
		return xt_Generator_Grid_ColumnList;
	}
	public void setXt_Generator_Grid_ColumnList(
			List<Xt_Generator_Grid_Column> xt_Generator_Grid_ColumnList) {
		this.xt_Generator_Grid_ColumnList = xt_Generator_Grid_ColumnList;
	}
	public List<Xt_Generator_Table_Column_Form> getXt_Generator_Table_Column_FormList() {
		return xt_Generator_Table_Column_FormList;
	}
	public void setXt_Generator_Table_Column_FormList(
			List<Xt_Generator_Table_Column_Form> xt_Generator_Table_Column_FormList) {
	...
	public List<Xt_Generator_TableMany_To_One> getXt_Generator_TableMany_To_OneList() {
		return xt_Generator_TableMany_To_OneList;
	}
	public void setXt_Generator_TableMany_To_OneList(
			List<Xt_Generator_TableMany_To_One> xt_Generator_TableMany_To_OneList) {
