...
//    private static JedisPool pool2;
    static {
        ...
        /*第一台服务器,阿里云上*/
        JedisShardInfo jedisShardInfo1 = new JedisShardInfo("192.168.1.1",6379);
        /*第二台服务器，公司内部测试*/
        JedisShardInfo jedisShardInfo2 = new JedisShardInfo("192.168.1.2",6379);
        List<JedisShardInfo> list = new LinkedList<JedisShardInfo>();
        list.add(jedisShardInfo1);
        list.add(jedisShardInfo2);
        shardedJedisPool = new ShardedJedisPool(config, list);
        /*第一台服务器
        pool1=new JedisPool("192.168.1.1", 6379);
        */
        /*第二台服务器
        pool2=new JedisPool("192.168.1.2", 6379);
        */
    }
