...
*/
@Repository("xt_UnitDao")
public class Xt_UnitDaoImpl  extends BaseDaoImpl implements Xt_UnitDao{
	/**
	* 分页
	* @param condition 
	* @return
	*/
	...
	public List<Xt_Unit> getXtUnitListByCondition(Map<String,Object> condition){
		return (List<Xt_Unit>)this.getList("getXtUnitListByCondition",condition);
	}
	/**
	* 查询对象
	* @param xt_unit_id 
	...
	*/
	public Xt_Unit getXtUnitById(String xt_unit_id){
		return (Xt_Unit)this.get("getXtUnitById", xt_unit_id);
	}
	/**
	* 添加
	* @param xt_unit 
