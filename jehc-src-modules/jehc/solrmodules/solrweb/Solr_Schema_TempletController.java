...
public class Solr_Schema_TempletController extends BaseAction{
	@Autowired
	private Solr_Schema_TempletService solr_Schema_TempletService;
	/**
	* 载入初始化页面
	...
	*/
	...
	public ModelAndView loadSolrSchemaTemplet(Solr_Schema_Templet solr_Schema_Templet,HttpServletRequest request){
	...
	*/
	...
	public String getSolrSchemaTempletListByCondition(Solr_Schema_Templet solr_Schema_Templet,HttpServletRequest request){
		...
		List<Solr_Schema_Templet> solr_Schema_TempletList = solr_Schema_TempletService.getSolrSchemaTempletListByCondition(condition);
		PageInfo<Solr_Schema_Templet> page = new PageInfo<Solr_Schema_Templet>(solr_Schema_TempletList);
	...
	*/
	...
	public String getSolrSchemaTempletById(String solr_schema_templet_id,HttpServletRequest request){
		Solr_Schema_Templet solr_Schema_Templet = solr_Schema_TempletService.getSolrSchemaTempletById(solr_schema_templet_id);
	...
	*/
	...
	public String addSolrSchemaTemplet(Solr_Schema_Templet solr_Schema_Templet,HttpServletRequest request){
		int i = 0;
		if(null != solr_Schema_Templet && !"".equals(solr_Schema_Templet)){
			...
			i=solr_Schema_TempletService.addSolrSchemaTemplet(solr_Schema_Templet);
		}
		if(i>0){
	...
	*/
	...
	public String updateSolrSchemaTemplet(Solr_Schema_Templet solr_Schema_Templet,HttpServletRequest request){
		int i = 0;
		if(null != solr_Schema_Templet && !"".equals(solr_Schema_Templet)){
			solr_Schema_Templet.setXt_userinfo_id(getXtUid());
			solr_Schema_Templet.setSolr_schema_templet_content(request.getParameter("solr_schema_templet_content"));
			solr_Schema_Templet.setSolr_schema_templet_mtime(getSimpleDateFormat());
			i=solr_Schema_TempletService.updateSolrSchemaTemplet(solr_Schema_Templet);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String delSolrSchemaTemplet(String solr_schema_templet_id,HttpServletRequest request){
		...
		if(null != solr_schema_templet_id && !"".equals(solr_schema_templet_id)){
			...
			i=solr_Schema_TempletService.delSolrSchemaTemplet(condition);
		}
		if(i>0){
			return outAudStr(true);
		}else{
	...
	*/
	...
	public String getSolrSchemaTempletList(Solr_Schema_Templet solr_Schema_Templet,HttpServletRequest request){
		Map<String, Object> condition = new HashMap<String, Object>();
