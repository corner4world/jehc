...
*/
public class Solr_Core extends BaseEntity implements Serializable{
	...
	//////////////////////////以下三个在查询中调用//////////////////////////
	private List<Solr_Index> solr_index_list;//索引集合
	private List<Solr_Sort> solr_sort_list;//排序集合
	private List<Solr_Index_Attribute> solr_index_attribute_list;//索引属性集合
	//////////////////////////以上三个在查询中调用//////////////////////////
	public List<Solr_Index> getSolr_index_list() {
		return solr_index_list;
	}
	public void setSolr_index_list(List<Solr_Index> solr_index_list) {
	...
	public List<Solr_Sort> getSolr_sort_list() {
		return solr_sort_list;
	}
	public void setSolr_sort_list(List<Solr_Sort> solr_sort_list) {
		this.solr_sort_list = solr_sort_list;
	}
	public List<Solr_Index_Attribute> getSolr_index_attribute_list() {
		return solr_index_attribute_list;
	}
	public void setSolr_index_attribute_list(
			List<Solr_Index_Attribute> solr_index_attribute_list) {
