...
public class XtDataAuthorityDefault extends BaseEntity implements Serializable{
	...
	private String xt_data_authority_d_value;/**固定值1按人员默认初始化基本数据权限2按部门默认初始化基本数据权限3按岗位默认初始化基本数据权限4按部门启动上下级基本数据权限5按岗位启动上下级基本数据权限**/
	...
	public String getXt_data_authority_d_value() {
		return xt_data_authority_d_value;
	}
	public void setXt_data_authority_d_value(String xt_data_authority_d_value) {
		this.xt_data_authority_d_value = xt_data_authority_d_value;
	}
