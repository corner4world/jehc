...
public class BProduct extends BaseEntity implements Serializable{
	...
	public List<BProductImgDefault> getBproductImgDefaultList() {
		return bproductImgDefaultList;
	}
	public void setBproductImgDefaultList(List<BProductImgDefault> bproductImgDefaultList) {
		this.bproductImgDefaultList = bproductImgDefaultList;
	}
