package jehc.paymodules.fuiou.apiservice;
...
public class FuiouPayServiceImpl extends PayServiceImpl {
    //日志
    protected final Log log = LogFactory.getLog(FuiouPayServiceImpl.class);
    //正式域名
    ...
    public String getReqUrl(){
        return payConfigDao.isTest() ? DEV_URL_FUIOUBASEDOMAIN : URL_FuiouBaseDomain;
    }

    /**
     * 构造函数，初始化时候使用
     * @param payConfigDao 支付账户配置信息
     * @param configDao 网络代理配置
     */
    public FuiouPayServiceImpl (PayConfigDao payConfigDao, HttpConfigDb configDao) {
     ...
     * @param payConfigDao 支付账户配置信息
     */
    public FuiouPayServiceImpl (PayConfigDao payConfigDao) {
        super(payConfigDao);
    }
    ...
    public boolean signVerify(Map<String, Object> params, String responseSign) {
        ...
        String sign = createSign(SignUtils.parameters2MD5Str(params, "|"), payConfigDao.getInputCharset());
    ...
    public boolean verifySource(String order_id) {
        ...
        params.put("mchnt_cd", payConfigDao.getPid());
        params.put("order_id", order_id);
        params.put("md5", createSign(SignUtils.parameters2MD5Str(params, "|"), payConfigDao.getInputCharset()));
    ...
    public Map<String, Object> orderInfo(PayOrder order) {
        ...
        String sign = createSign(SignUtils.parameters2MD5Str(parameters, "|"), payConfigDao.getInputCharset());
    ...
    private LinkedHashMap<String, Object> getOrderInfo(PayOrder order) {
        ...
        parameters.put("mchnt_cd", payConfigDao.getPid());//商户代码
...
//        parameters.put("cur_type", null == order.getCurType() ? FuiouCurType.CNY:order.getCurType());//交易币种
        ...
        parameters.put("page_notify_url", payConfigDao.getReturnUrl());//商户接受支付结果通知地址
        parameters.put("back_notify_url", StringUtils.isBlank(payConfigDao.getNotifyUrl()) ? "" : payConfigDao.getNotifyUrl());//商户接受的支付结果后台通知地址 //非必填
    ...
    public String createSign(String content, String characterEncoding) {
        return SignUtils.valueOf(payConfigDao.getSignType().toUpperCase()).createSign(content, "|" + payConfigDao.getKeyPrivate(), characterEncoding);
    }
    ...
    public Map<String, Object> refund (RefundOrder refundOrder) {
        ...
        params.put("mchnt_cd",payConfigDao.getPid());//商户代码
