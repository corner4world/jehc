package jehc.paymodules.ali.apiservice;
...
public class AliPayServiceImpl extends PayServiceImpl {
    ...
    public String getReqUrl(){
        return payConfigDao.isTest() ? devReqUrl : httpsReqUrl;
    }
    ...
    public boolean signVerify(Map<String, Object> params, String sign) {
        if (params instanceof JSONObject){
            for (String key : params.keySet()){
                ...
                return SignUtils.valueOf(payConfigDao.getSignType()).verify(JSON.toJSONString(linkedHashMap),  sign,  payConfigDao.getKeyPublic(), payConfigDao.getInputCharset());
            }
        }
    ...
    private Map<String, Object> setSign(Map<String, Object> parameters){
        ...
        String sign = createSign( SignUtils.parameterText(parameters, "&", "sign"), payConfigDao.getInputCharset());
    ...
    private  Map<String, Object> getOrder(PayOrder order) {
        ...
        bizContent.put("seller_id", payConfigDao.getSeller());
