package jehc.paymodules.wx.apiservice;
...
import jehc.paymodules.wx.model.WxPayError;
import jehc.paymodules.wx.model.WxTransactionType;

/**
 * 微信支付服务
 */
public class WxPayServiceImpl extends PayServiceImpl {
    protected final Log LOG = LogFactory.getLog(WxPayServiceImpl.class);
    /**
     * 微信请求地址
     */
    ...
    /**
     * 创建支付服务
     * @param payConfigDao 微信对应的支付配置
     */
    public WxPayServiceImpl(PayConfigDao payConfigDao) {
        super(payConfigDao);
    }
    /**
     * 创建支付服务
     * @param payConfigDao 微信对应的支付配置
     * @param configDao 微信对应的网络配置，包含代理配置、ssl证书配置
     */
    public WxPayServiceImpl(PayConfigDao payConfigDao, HttpConfigDb configDao) {
    ...
    private String getUrl(TransactionType transactionType) {
        return URI + (payConfigDao.isTest() ? SANDBOXNEW : "") + transactionType.getMethod();
    }
    ...
    public boolean signVerify(Map<String, Object> params, String sign) {
        return SignUtils.valueOf(payConfigDao.getSignType()).verify(params, sign, "&key=" + payConfigDao.getKeyPrivate(), payConfigDao.getInputCharset());
    }
    ...
    private Map<String, Object> getPublicParameters() {
        ...
        parameters.put("appid", payConfigDao.getAppid());
        parameters.put("mch_id", payConfigDao.getPid());
    ...
    public JSONObject unifiedOrder(PayOrder order) {
        ...
        parameters.put("notify_url", payConfigDao.getNotifyUrl());
        ...
        String sign = createSign(SignUtils.parameterText(parameters), payConfigDao.getInputCharset());
    ...
    public Map<String, Object> orderInfo(PayOrder order) {
        ...
        if (verify(result)) {
            ...
            if (WxTransactionType.JSAPI == order.getTransactionType()) {
                params.put("signType", payConfigDao.getSignType());
                params.put("appId", payConfigDao.getAppid());
                ...
                params.put("partnerid", payConfigDao.getPid());
                params.put("appid", payConfigDao.getAppid());
            ...
            String paySign = createSign(SignUtils.parameterText(params), payConfigDao.getInputCharset());
    ...
    public String createSign(String content, String characterEncoding) {
        return SignUtils.valueOf(payConfigDao.getSignType().toUpperCase()).createSign(content, "&key=" + payConfigDao.getKeyPrivate(), characterEncoding).toUpperCase();
    }
    ...
    public String buildRequest(Map<String, Object> orderInfo, MethodType method) {
        ...
        if (WxTransactionType.MWEB.name().equals(orderInfo.get("trade_type"))) {
            return String.format("<script type=\"text/javascript\">location.href=\"%s%s\"</script>",orderInfo.get("mweb_url"), StringUtils.isEmpty(payConfigDao.getReturnUrl()) ? "" : "&redirect_url=" + URLEncoder.encode(payConfigDao.getReturnUrl()));
        }
    ...
    public Map<String, Object> refund(RefundOrder refundOrder) {
        ...
        parameters.put("op_user_id", payConfigDao.getPid());
    ...
    public Map<String, Object> transfer(TransferOrder order) {
        Map<String, Object> parameters = new TreeMap<String, Object>();
        //转账到余额
//        parameters.put("mch_appid", payConfigDao.getAppid());
        parameters.put("mch_id", payConfigDao.getPid());
        ...
        parameters.put(SIGN, SignUtils.valueOf(payConfigDao.getSignType()).sign(parameters, payConfigDao.getKeyPrivate(), payConfigDao.getInputCharset()));
    ...
    public String keyPublic(String content){
        return SignUtils.RSA.createSign(content, payConfigDao.getKeyPublic(), payConfigDao.getInputCharset());
    }
}
