...
public class HttpRequestTemplate {
    ...
    public CloseableHttpClient getHttpClient() {
        ...
        if (null == HttpConfigDb) {
            return httpClient = HttpClients.createDefault();
        }
        CloseableHttpClient httpClient = HttpClients
                .custom()
                //网络提供者
                .setDefaultCredentialsProvider(createCredentialsProvider(HttpConfigDb))
                //设置httpclient的SSLSocketFactory
                .setSSLSocketFactory(createSSL(HttpConfigDb))
                .setConnectionManager(connectionManager(HttpConfigDb))
                .build();
     ...
     */
    public HttpRequestTemplate(HttpConfigDb configStorage) {
     ...
     */
    public SSLConnectionSocketFactory createSSL( HttpConfigDb configStorage){
     ...
     * @return 凭据提供程序
     */
    public CredentialsProvider createCredentialsProvider(HttpConfigDb configStorage){
     ...
     * @return 连接池对象
     */
    public PoolingHttpClientConnectionManager connectionManager(HttpConfigDb configStorage){
        if (null != connectionManager){
     ...
     */
    public HttpRequestTemplate setHttpConfigStorage(HttpConfigDb configStorage) {
        this.HttpConfigDb = configStorage;
