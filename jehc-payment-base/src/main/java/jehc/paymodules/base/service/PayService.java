package jehc.paymodules.base.service;
...
public interface PayService {
     ...
     * @return 支付服务
     */
    PayService setPayConfigDao(PayConfigDao payConfigDao);
    /**
     * 获取支付配置
     * @return 支付配置
     */
    PayConfigDao getPayConfigDao();
    /**
     * 获取http请求工具
     * @return http请求工具
     */
     ...
     * @return  支付服务
     */
    PayService setRequestTemplateConfigDao(HttpConfigDb configDao);
    /**
     * 回调校验
    ...
    /**
     * @param tradeNoOrBillDate 支付平台订单号或者账单类型， 具体类型为{@link String }或者 {@link Date }，类型须强制限制，类型不对应则抛出异常{@link PayErrorException}
